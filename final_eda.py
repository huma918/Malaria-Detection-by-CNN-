...
def display_samples(generator):
    x, y = next(generator)
    batch_size = x.shape[0]  # Get the actual number of images in the batch (it should be 5 here)
    plt.figure(figsize=(10, 10))
...
class_weights = {0: parasitized_count / (parasitized_count + uninfected_count),
                 1: uninfected_count / (parasitized_count + uninfected_count)}
